  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Form.Item label="Description" required>
        <Input.TextArea placeholder="Description" value={eventData.description} onChange={(e) => setEventData({...eventData, description : e.target.value})} />
      </Form.Item>


      <Form.Item label="Organizer" required>
        <Input.TextArea placeholder="Organizer" value={eventData.organizer} onChange={(e) => setEventData({...eventData, organizer : e.target.value})} />
      </Form.Item>

      <Form.Item
      label="Guests list (comma seperated)" required
      >
        <div className="flex gap-5">
        <Input placeholder="Guests list (comma seperated)" value={guestInputValue} onChange={(e) => setGuestInputValue(e.target.value)} />
